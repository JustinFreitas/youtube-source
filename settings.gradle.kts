...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            version("lavaplayer-v1", "v2.2.7_14")
            version("lavaplayer-v2", "v2.2.7_14")
            ...
            library("groovy", "org.apache.groovy", "groovy").version("5.1.1")
            ...
            library("byte-buddy", "net.bytebuddy", "byte-buddy").version("1.18.13")
            library("byte-buddy-agent", "net.bytebuddy", "byte-buddy-agent").version("1.18.13")
